...
## Bss section clear
## @note:
## Clear the .bss section using the X indirect register.
## The indirect register X are composed by to register:
##	* r26 -> XH (MSB) of the 16-bits address 
##	* r27 -> XL (LSB) of the 16-bits address
##
## Here we start at <0x0100> (start of the SRAM) and end at
## <0x0118>. So we can calculate that the .bss section
## size is 24 (In the main I use "uint16_t test[12]" -> 24o)
##
##
##
##
...
00000074 <__do_clear_bss>:
  74:	21 e0       	ldi	r18, 0x01	; r18 = 0x01
  76:	a0 e0       	ldi	r26, 0x00	; r26 = 0x00 (XH indirect)
  78:	b1 e0       	ldi	r27, 0x01	; r27 = 0x01 (XL indirect)
  7a:	01 c0       	rjmp	.+2      	; jump at <.do_clear_bss_start>			     ---
													|
# Clear loop												|
0000007c <.do_clear_bss_loop>:										|
  7c:	1d 92       	st	X+, r1		; *(address++) = 0x00			    < --	|
												|	|
# Check if the current address overlap the end							|	|
# of the .bss section.										|	|
0000007e <.do_clear_bss_start>:									|	|
  7e:	a8 31       	cpi	r26, 0x18	; r16 - 0x18 == 0 -> C = 1...			|   < --
  80:	b2 07       	cpc	r27, r18	; if r27 - r18 - C == 0....			|
  82:	e1 f7       	brne	.-8      	; ...if not, jump at <.do_clear_bss_loop>    ---


##
## Call main entry and call _exit when the main's end.
##
...
00000090 <main>:
  ...
  9a:	e8 31       	cpi	r30, 0x18	; 24
  9c:	f2 07       	cpc	r31, r18
  9e:	d1 f7       	brne	.-12     	; 0x94 <main+0x4>
  ...
  be:	45 2b       	or	r20, r21
  c0:	21 f4       	brne	.+8      	; 0xca <main+0x3a>
  c2:	01 96       	adiw	r24, 0x01	; 1
  c4:	be 01       	movw	r22, r28
  c6:	0e 94 72 00 	call	0xe4	; 0xe4 <__divmodhi4>
...
000000e4 <__divmodhi4>:
  ...
  ea:	00 94       	com	r0
  ec:	07 d0       	rcall	.+14     	; 0xfc <__divmodhi4_neg1>
  ee:	77 fd       	sbrc	r23, 7
  f0:	09 d0       	rcall	.+18     	; 0x104 <__divmodhi4_neg2>
  f2:	0e 94 86 00 	call	0x10c	; 0x10c <__udivmodhi4>
  f6:	07 fc       	sbrc	r0, 7
  f8:	05 d0       	rcall	.+10     	; 0x104 <__divmodhi4_neg2>
  fa:	3e f4       	brtc	.+14     	; 0x10a <__divmodhi4_exit>

000000fc <__divmodhi4_neg1>:
  fc:	90 95       	com	r25
  fe:	81 95       	neg	r24
...
0000010c <__udivmodhi4>:
 10c:	aa 1b       	sub	r26, r26
 10e:	bb 1b       	sub	r27, r27
 110:	51 e1       	ldi	r21, 0x11	; 17
 112:	07 c0       	rjmp	.+14     	; 0x122 <__udivmodhi4_ep>

00000114 <__udivmodhi4_loop>:
 114:	aa 1f       	adc	r26, r26
 116:	bb 1f       	adc	r27, r27
 118:	a6 17       	cp	r26, r22
 11a:	b7 07       	cpc	r27, r23
 11c:	10 f0       	brcs	.+4      	; 0x122 <__udivmodhi4_ep>
 11e:	a6 1b       	sub	r26, r22
 120:	b7 0b       	sbc	r27, r23

00000122 <__udivmodhi4_ep>:
 122:	88 1f       	adc	r24, r24
 124:	99 1f       	adc	r25, r25
 126:	5a 95       	dec	r21
 128:	a9 f7       	brne	.-22     	; 0x114 <__udivmodhi4_loop>
 12a:	80 95       	com	r24
 12c:	90 95       	com	r25
...
00000000 <.debug_info>:
  ...
  6e:	00 00       	nop
  70:	01 05       	cpc	r16, r1
  72:	03 c1       	rjmp	.+518    	; 0x27a <__data_load_end+0x142>
  74:	00 80       	ld	r0, Z
  76:	00 0a       	sbc	r0, r16
